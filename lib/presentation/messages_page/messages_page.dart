...
import '../messages_page/widgets/stories_item_widget.dart';
        ...
        child: SizedBox(
            ...
            child: Obx(() => ListView.separated(
                ...
                itemCount: controller
                    .messagesModelObj.value.storiesItemList.value.length,
                itemBuilder: (context, index) {
                  StoriesItemModel model = controller
                      .messagesModelObj.value.storiesItemList.value[index];
